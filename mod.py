...
class InventoryManager:
    ...
    def _save_data(self):
        """
        This function's job is to take all the inventory data we have in memory
        (in our `self.items` dictionary) and write it down into our 'inventory.json' file.
        We call this every time we make a change (add, update, delete)
        to ensure our data is always up-to-date on your computer.
        """
        try:
...
# --- The very beginning of our application when you run the Python script! ---
